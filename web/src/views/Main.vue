<template>
  <div>
    <div class="topbar bg-black py-2 px-3 d-flex ai-center">
      ...
      <button type="button" class="btn text-dark bg-primary">立即下载</button>
    </div>
    <div class="bg-primary pt-3 pb-2">
      <div class="nav nav-inverse text-white pb-1 jc-around">
        ...
        <div class="nav-item">
          <router-link class="nav-link" tag="div" to="/ce">攻略中心</router-link>
        </div>
        <div class="nav-item">
          <router-link class="nav-link" tag="div" to="/ce">赛事中心</router-link>
        </div>
      </div>
    </div>
